...
public class CnaAbiTests
{
    ...
    public void RequiredSymbols_AreEveryDeclaredNativeImport()
    {
        ...
        // 910: five from A3/A4/A5, two for A1, fourteen for D2's first CNB slice, six for D3's
        // engine-layer render target pool, fourteen for D2's second -- the CNB texture decode family
        // plus the device's surface-format support query -- and fifteen for D3's second, the
        // post-process pass and chain family.
        ...
        Assert.Equal(910, declared.Length);
