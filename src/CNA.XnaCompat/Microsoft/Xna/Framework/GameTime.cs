...
/// properties (unlike CNA.Framework's immutable <c>GameTime</c> struct); this matches XNA's shape
...
public class GameTime
{
    ...
    internal static GameTime FromFramework(CNA.Framework.GameTime framework) =>
