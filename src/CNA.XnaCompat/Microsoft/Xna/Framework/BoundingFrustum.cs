...
/// <see cref="CNA.BoundingFrustum"/> -- no duplicated fields or logic. Only
...
/// </summary>
public sealed class BoundingFrustum : CNA.BoundingFrustum
{
    ...
    {
        CNA.Vector3[] source = base.GetCorners();
