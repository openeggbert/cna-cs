...
public class BasicEffect : Effect, IEffectMatrices, IEffectFog, IEffectLights, CNA.Graphics.IEffectMatrices, CNA.Graphics.IEffectFog, CNA.Graphics.IEffectLights
{
