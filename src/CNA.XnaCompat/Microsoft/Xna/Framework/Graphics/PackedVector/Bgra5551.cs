...
public struct Bgra5551 : IPackedVector<ushort>, IEquatable<Bgra5551>
{
    ...
    {
        PackedValue = new CNA.Graphics.PackedVector.Bgra5551(x, y, z, w).PackedValue;
    }

    public Bgra5551(Vector4 vector)
    {
        PackedValue = new CNA.Graphics.PackedVector.Bgra5551(vector.ToFramework()).PackedValue;
    }
