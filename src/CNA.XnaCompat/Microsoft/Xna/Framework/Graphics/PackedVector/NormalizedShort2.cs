...
public struct NormalizedShort2 : IPackedVector<uint>, IEquatable<NormalizedShort2>
{
    ...
    {
        PackedValue = new CNA.Graphics.PackedVector.NormalizedShort2(vector).PackedValue;
    }
    ...
    public static implicit operator CNA.Graphics.PackedVector.NormalizedShort2(NormalizedShort2 value) =>
        new() { PackedValue = value.PackedValue };

    public static implicit operator NormalizedShort2(CNA.Graphics.PackedVector.NormalizedShort2 value) =>
        new() { PackedValue = value.PackedValue };
}
