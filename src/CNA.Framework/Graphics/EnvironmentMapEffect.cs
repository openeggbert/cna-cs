...
public class EnvironmentMapEffect : StockEffect, IEffectMatrices, IEffectFog, IEffectLights
{
    ...
    private EnvironmentMapEffect(GraphicsDevice graphicsDevice, CnaHandle nativeHandle)
    ...
    /// <see cref="EnvironmentMapEffect"/> correct rather than a guess.</summary>
    public override Effect Clone() => new EnvironmentMapEffect(GraphicsDevice, CloneNativeHandle());
}
