...
| Measured | Result |
| --- | --- |
| Consumed entry points absent | 0 of 996 |
...
`tools/abi-verify` independently passes **906 native and 906 managed** C-authority layout
measurements with 0 mismatches, compiles 996 of 996 prototypes, checks 6 callbacks, asserts 353
