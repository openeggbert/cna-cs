...
| Measured | Result |
| --- | --- |
| Consumed entry points absent | 0 of 854 |
| Consumed entry points with a changed header prototype | 0 |
...
for the 854 names imported by this build.
...
2. every one of the 854 `LibraryImport` entry points declared by `CNA.Interop.Native`;
